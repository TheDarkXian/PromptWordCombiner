...
const messages: Record<UiLanguage, Partial<Record<TranslationKey, TranslationValue>>> = {
  'zh-CN': {
    ...
    'sidebar.nav': '节点导航',
    'sidebar.build': '导出烘焙',
    'sidebar.importVarTable': '导入变量数据',
    'sidebar.exportJson': '导出 JSON',
    'sidebar.exportCsv': '导出 CSV',
    'sidebar.inputVars': '模板变量',
    'sidebar.localVars': '项目变量',
    'sidebar.resultVars': '生成变量',
    'sidebar.duplicateVar': '无法复制',
    'sidebar.duplicateVarMessage': '这个变量当前没有内容可复制。',
    'sidebar.varNamePlaceholder': '名称...',
    'sidebar.cancel': '取消',
    'sidebar.add': '添加',
    'sidebar.addLocalVar': '+ 新增变量',
    'sidebar.noResultVars': '暂无生成变量。',
    ...
    'templateEditor.inputSection': '1. 变量',
    ...
    'templateEditor.promptPlaceholder': '编写提示词，例如：根据 [[topic]] 生成内容，或用 --global-- 引用全局变量...',
    ...
    'templateEditor.outputToVar': '返回值',
    'templateEditor.bindingHelp': '留空表示不声明文本返回值。配置后，这个步骤会把原始返回解析到对应返回值。',
    'templateEditor.varKey': '变量 Key',
    'templateEditor.displayName': '显示名',
    'templateEditor.bindingKnown': '当前 key 已存在于模板上下文中。',
    'templateEditor.bindingNew': '当前 key 还不存在，将创建新的变量。',
    'templateEditor.addStep': '添加新步骤',
    'templateEditor.defaultModelRefLabel': ({ count }) => `模型引用 ${count}`,
    'templateEditor.deleteInputTitle': '删除变量',
    'templateEditor.deleteInputMessage': '确认删除这个变量吗？依赖它的步骤占位符需要你手动调整。',
    ...
    'templateEditor.bindingSummaryUnbound': '未声明文本返回值',
    'templateEditor.bindingSummaryBound': ({ key }) => `返回值 -> {{${key}}}`,
    'templateEditor.expandBinding': '展开返回值配置',
    'templateEditor.collapseBinding': '收起返回值配置',
  ...
  'en-US': {
    ...
    'step.prompt': 'Prompt',
    'step.outputVar': 'Save to variable',
    'step.source': 'Source',
    'step.missing': 'Missing',
    'step.staleLabel': 'Stale',
    'step.result': 'Result',
    'step.resultHint': "Supports [[function]] / --variable--",
    ...
    'sidebar.nav': 'Nodes',
    'sidebar.build': 'Bake',
    'sidebar.importVarTable': 'Import variable data',
    'sidebar.exportJson': 'Export JSON',
    'sidebar.exportCsv': 'Export CSV',
    'sidebar.inputVars': 'Template variables',
    'sidebar.localVars': 'Project variables',
    'sidebar.resultVars': 'Generated variables',
    ...
    'sidebar.add': 'Add',
    'sidebar.addLocalVar': '+ Add variable',
    'sidebar.noResultVars': 'No generated variables yet.',
    ...
    'templateEditor.inputSection': '1. Variables',
    ...
    'templateEditor.promptPlaceholder': 'Write the prompt, for example: generate content from [[topic]], or use --global-- for globals...',
    ...
    'templateEditor.outputToVar': 'Save to variable',
    'templateEditor.bindingHelp': 'Leaving the variable key empty means the result is not saved. Once configured, this step saves its result to that variable.',
    ...
    'templateEditor.bindingNew': 'This key does not exist yet and will create a new variable.',
    'templateEditor.addStep': 'Add new step',
    'templateEditor.defaultModelRefLabel': ({ count }) => `Model ref ${count}`,
    'templateEditor.deleteInputTitle': 'Delete variable',
    'templateEditor.deleteInputMessage': 'Delete this variable? Steps that depend on it may need manual placeholder updates.',
    ...
    'templateEditor.bindingSummaryUnbound': 'Not saved to a variable',
    'templateEditor.bindingSummaryBound': ({ key }) => `Result saves to {{${key}}}`,
...
Object.assign(messages['zh-CN'], {
  ...
  'step.structuredParsing': '变量表解析中',
  'step.structuredAwaitingConfirm': '等待覆盖确认',
  'step.structuredUpdated': '已更新变量表',
  'step.structuredSkipped': '已跳过变量表解析',
  'step.structuredFailed': '变量表解析失败',
  'step.structuredOverwriteTitle': '覆盖变量表',
  'step.structuredOverwriteTitleAutomation': '自动流程检测到已有结果',
  'step.structuredOverwriteMessage': '检测到该步骤已有变量表数据，是否覆盖并重新解析？',
  'step.structuredOverwriteMessageAutomation': '自动执行时检测到该步骤已有变量表数据，是否覆盖并继续解析？',
...
Object.assign(messages['en-US'], {
  ...
  'project.producerOutputVar': 'Save to variable',
  ...
  'step.structuredParsing': 'Parsing variable table',
  'step.structuredAwaitingConfirm': 'Waiting for overwrite confirmation',
  'step.structuredUpdated': 'Variable table updated',
  'step.structuredSkipped': 'Variable table parsing skipped',
  'step.structuredFailed': 'Variable table parsing failed',
  'step.structuredOverwriteTitle': 'Overwrite variable table',
  'step.structuredOverwriteTitleAutomation': 'Existing result detected in automation',
  'step.structuredOverwriteMessage': 'Variable table data already exists for this step. Overwrite and parse again?',
  'step.structuredOverwriteMessageAutomation':
    'Automation detected existing variable table data for this step. Overwrite and continue parsing?',
  'step.structuredSkipParse': 'Skip parse',
  'step.structuredOverwriteAndParse': 'Overwrite and parse',
});

Object.assign(messages['zh-CN'], {
  'project.updateProducers': '更新输出函数',
  'project.producerPreflightTitle': '更新输出函数',
  'project.producerPreflightSubtitle':
    '先检查当前项目中会声明返回值的提示词函数，再决定哪些已有返回需要覆盖。',
  'project.producerNothingToRun': '当前没有可执行的提示词函数。',
  'project.producerResultTitle': '提示词函数更新结果',
  'project.producerCurrent': '当前函数',
  'project.producerWillOverwrite': '将覆盖现有返回',
  'project.producerOutputVar': '返回值',
  'project.producerNoReady': '本次没有提示词函数会进入执行。',
  'project.producerScopeAll': '全量更新输出函数',
  'step.unknownMessage': '当前提示词函数的执行状态未知。',
  'step.prompt': '函数体',
  'step.outputVar': '返回值',
  'step.result': '函数输出',
  'step.resultHint': '支持 [[函数]] / --变量--',
  'step.resultPlaceholder': '这里可以存放函数输出、人工备注或后续要复用的文本...',
  'step.clearStepLogsTitle': '清空函数日志',
  'step.clearStepLogsMessage': '清空这个提示词函数的运行日志？函数输出会保留。',
  'step.roleText': '提示词函数',
  'step.roleManual': '人工函数',
  'step.roleExternal': '外部函数',
  'step.roleInfo': ({ role }) => `函数类型：${role}`,
  'step.structuredParsing': '表变量解析中',
  'step.structuredUpdated': '已更新表变量',
  'step.structuredSkipped': '已跳过表变量解析',
  'step.structuredFailed': '表变量解析失败',
  'step.structuredOverwriteTitle': '覆盖表变量',
  'step.structuredOverwriteMessage': '检测到该提示词函数已有表变量数据，是否覆盖并重新解析？',
  'step.structuredOverwriteMessageAutomation': '自动执行时检测到该提示词函数已有表变量数据，是否覆盖并继续解析？',
  'sidebar.vars': '变量',
  'sidebar.nav': '函数导航',
  'sidebar.inputVars': '输入变量',
  'sidebar.localVars': '项目变量',
  'sidebar.resultVars': '返回值',
  'sidebar.noResultVars': '暂无返回值。',
  'sidebar.stepSource': '来源函数',
  'sidebar.goSource': '跳到来源函数',
  'sidebar.bakeTitle': '函数体全量烘焙',
  'sidebar.bakeDescription': '一键合并所有提示词函数体并导出为 .txt 纯文本。',
  'templateEditor.inputSection': '1. 输入变量',
  'templateEditor.stepsSection': '3. 提示词函数',
  'templateEditor.inputHelp': '函数体里可以继续用 <序号>、<变量名> 或 --variable_key-- 引用全局变量。',
  'templateEditor.inputName': '输入变量名称',
  'templateEditor.selectAllSteps': '全选函数',
  'templateEditor.selectedSteps': ({ count }) => `已选中 ${count} 个函数`,
  'templateEditor.stepName': '函数名称',
  'templateEditor.promptContent': '函数体',
  'templateEditor.promptPlaceholder': '编写函数体，例如：根据 [[topic]] 生成内容，或用 --global-- 引用全局变量...',
  'templateEditor.outputToVar': '返回值',
  'templateEditor.bindingHelp': '留空表示不声明文本返回值。配置后，这个提示词函数会把原始返回解析到对应返回值。',
  'templateEditor.bindingSummaryUnbound': '未声明文本返回值',
  'templateEditor.bindingSummaryBound': ({ key }) => `返回值 -> {{${key}}}`,
  'templateEditor.expandBinding': '展开返回值配置',
  'templateEditor.collapseBinding': '收起返回值配置',
  'templateEditor.stepType': '函数类型',
  'templateEditor.stepTypeText': '提示词函数',
  'templateEditor.stepTypeManual': '人工函数',
  'templateEditor.stepTypeExternal': '外部函数',
  'templateEditor.stepTypeHelpText': '适合语言模型自动批量执行，并保留原始返回，可按声明解析返回值。',
  'templateEditor.stepTypeHelpManual': '自动流程到这里必须停下，由用户人工确认或编辑。',
  'templateEditor.stepTypeHelpExternal': '当前只生成函数体，不自动调用图像或视频模型。',
  'templateEditor.autoRunHelp': '只有提示词函数才会进入后续半自动执行范围。',
  'templateEditor.autoRunDisabledHelp': '只有提示词函数可以开启自动执行。',
  'templateEditor.addStep': '添加提示词函数',
  'templateEditor.deleteStepTitle': '删除提示词函数',
  'templateEditor.deleteStepMessage': '确认删除这个提示词函数吗？',
  'templateEditor.untitledStep': '未命名函数',
  'templateEditor.selectStep': '选择函数',
  'templateEditor.unselectStep': '取消选择函数',
});

Object.assign(messages['en-US'], {
  'project.updateProducers': 'Update returning functions',
  'project.producerPreflightTitle': 'Update returning functions',
  'project.producerPreflightSubtitle':
    'Check prompt functions that declare return values, then choose which existing returns should be overwritten.',
  'project.producerNothingToRun': 'There are no runnable prompt functions in the current project.',
  'project.producerResultTitle': 'Prompt function update results',
  'project.producerCurrent': 'Current function',
  'project.producerWillOverwrite': 'Will overwrite the existing return',
  'project.producerOutputVar': 'Return value',
  'project.producerNoReady': 'No prompt function will enter this run.',
  'project.producerScopeAll': 'All returning functions',
  'step.unknownMessage': 'The execution state of this prompt function is unknown.',
  'step.prompt': 'Function body',
  'step.outputVar': 'Return value',
  'step.result': 'Function output',
  'step.resultHint': 'Supports [[function]] / --variable--',
  'step.resultPlaceholder': 'Store function output, notes, or reusable text here...',
  'step.clearStepLogsTitle': 'Clear function logs',
  'step.clearStepLogsMessage': 'Clear run logs for this prompt function? The function output will stay unchanged.',
  'step.roleText': 'Prompt function',
  'step.roleManual': 'Manual function',
  'step.roleExternal': 'External function',
  'step.roleInfo': ({ role }) => `Function type: ${role}`,
  'step.structuredParsing': 'Parsing table variable',
  'step.structuredUpdated': 'Table variable updated',
  'step.structuredSkipped': 'Table variable parsing skipped',
  'step.structuredFailed': 'Table variable parsing failed',
  'step.structuredOverwriteTitle': 'Overwrite table variable',
  'step.structuredOverwriteMessage': 'Table variable data already exists for this prompt function. Overwrite and parse again?',
  'step.structuredOverwriteMessageAutomation':
    'Automation detected existing table variable data for this prompt function. Overwrite and continue parsing?',
  'sidebar.vars': 'Variables',
  'sidebar.nav': 'Functions',
  'sidebar.inputVars': 'Input variables',
  'sidebar.localVars': 'Project variables',
  'sidebar.resultVars': 'Return values',
  'sidebar.noResultVars': 'No return values yet.',
  'sidebar.stepSource': 'Source function',
  'sidebar.goSource': 'Go to source function',
  'sidebar.bakeTitle': 'Bake function bodies',
  'sidebar.bakeDescription': 'Merge all prompt function bodies and export them as a plain .txt file.',
  'templateEditor.inputSection': '1. Input variables',
  'templateEditor.stepsSection': '3. Prompt functions',
  'templateEditor.inputHelp': 'Function bodies can reference globals with <index>, <label>, or --variable_key--.',
  'templateEditor.inputName': 'Input variable name',
  'templateEditor.selectAllSteps': 'Select all functions',
  'templateEditor.selectedSteps': ({ count }) => `${count} function(s) selected`,
  'templateEditor.stepName': 'Function name',
  'templateEditor.promptContent': 'Function body',
  'templateEditor.promptPlaceholder': 'Write the function body, for example: generate content from [[topic]], or use --global-- for globals...',
  'templateEditor.outputToVar': 'Return value',
  'templateEditor.bindingHelp': 'Leaving this empty means no text return value is declared. Once configured, the raw response can be parsed into that return value.',
  'templateEditor.bindingSummaryUnbound': 'No text return value declared',
  'templateEditor.bindingSummaryBound': ({ key }) => `Return value -> {{${key}}}`,
  'templateEditor.expandBinding': 'Expand return value config',
  'templateEditor.collapseBinding': 'Collapse return value config',
  'templateEditor.stepType': 'Function type',
  'templateEditor.stepTypeText': 'Prompt function',
  'templateEditor.stepTypeManual': 'Manual function',
  'templateEditor.stepTypeExternal': 'External function',
  'templateEditor.stepTypeHelpText': 'Suitable for batch execution with language models and typed output variables.',
  'templateEditor.stepTypeHelpManual': 'The automatic flow must stop here for user review or edits.',
  'templateEditor.stepTypeHelpExternal': 'Currently only prepares the function body; it does not call image or video models.',
  'templateEditor.autoRunHelp': 'Only prompt functions can join later semi-automatic runs.',
  'templateEditor.autoRunDisabledHelp': 'Only prompt functions can enable automatic execution.',
  'templateEditor.addStep': 'Add prompt function',
  'templateEditor.deleteStepTitle': 'Delete prompt function',
  'templateEditor.deleteStepMessage': 'Delete this prompt function?',
  'templateEditor.untitledStep': 'Untitled function',
  'templateEditor.selectStep': 'Select function',
  'templateEditor.unselectStep': 'Unselect function',
});
