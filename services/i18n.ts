...
const messages: Record<UiLanguage, Partial<Record<TranslationKey, TranslationValue>>> = {
  'zh-CN': {
    ...
    'templateEditor.outputToVar': '保存到变量',
    'templateEditor.bindingHelp': '变量 key 为空就表示不保存。配置后，这个步骤的结果会保存到对应变量。',
    ...
    'templateEditor.bindingSummaryUnbound': '未保存到变量',
    'templateEditor.bindingSummaryBound': ({ key }) => `结果保存到 {{${key}}}`,
...
Object.assign(messages['zh-CN'], {
  ...
  'project.producerOutputVar': '保存到变量',
...
Object.assign(messages['zh-CN'], {
  ...
  'sidebar.localVars': '项目变量',
  'sidebar.resultVars': '输出变量',
  'sidebar.noResultVars': '暂无输出变量。',
  ...
  'templateEditor.inputHelp': '函数体里可以继续用 <序号>、<变量名> 或 {{variable_key}} 引用输入变量。',
  ...
  'templateEditor.promptPlaceholder': '编写函数体，例如：根据 {{topic}} 生成内容...',
  'templateEditor.outputToVar': '输出变量',
  'templateEditor.bindingHelp': '变量 key 为空就表示不声明文本输出。配置后，这个提示词函数的结果会写入对应输出变量。',
  'templateEditor.bindingSummaryUnbound': '未声明文本输出变量',
  'templateEditor.bindingSummaryBound': ({ key }) => `文本输出 -> {{${key}}}`,
  'templateEditor.expandBinding': '展开输出变量配置',
  'templateEditor.collapseBinding': '收起输出变量配置',
  ...
  'templateEditor.stepTypeHelpText': '适合语言模型自动批量执行，并把结果写入输出变量。',
  'templateEditor.stepTypeHelpManual': '自动流程到这里必须停下，由用户人工确认或编辑。',
...
Object.assign(messages['en-US'], {
  'project.updateProducers': 'Update output functions',
  'project.producerPreflightTitle': 'Update output functions',
  'project.producerPreflightSubtitle':
    'Check prompt functions that produce output variables, then choose which existing outputs should be overwritten.',
  ...
  'sidebar.localVars': 'Project variables',
  'sidebar.resultVars': 'Output variables',
  'sidebar.noResultVars': 'No output variables yet.',
  ...
  'templateEditor.inputHelp': 'Function bodies can reference input variables with <index>, <label>, or {{variable_key}}.',
  ...
  'templateEditor.promptPlaceholder': 'Write the function body, for example: generate content from {{topic}}...',
  'templateEditor.outputToVar': 'Output variable',
  'templateEditor.bindingHelp': 'Leaving the variable key empty means no text output is declared. Once configured, this prompt function writes its result to that output variable.',
  'templateEditor.bindingSummaryUnbound': 'No text output variable declared',
  'templateEditor.bindingSummaryBound': ({ key }) => `Text output -> {{${key}}}`,
  'templateEditor.expandBinding': 'Expand output variable config',
  'templateEditor.collapseBinding': 'Collapse output variable config',
